...
HDL_SOURCES = [
    ...
    # FSM Observer and voltage package (from forge-vhdl)
    PROJECT_ROOT.parent / "forge-vhdl" / "vhdl" / "packages" / "forge_voltage_5v_bipolar_pkg.vhd",
    PROJECT_ROOT.parent / "forge-vhdl" / "vhdl" / "debugging" / "fsm_observer.vhd",
