...
TESTS_CONFIG = {
    ...
    "example_counter_mcc": TestConfig(
        name="example_counter_mcc",
        sources=[
            VHDL_PKG / "forge_common_pkg.vhd",                                    # FORGE control scheme
            VHDL_DEBUG / "forge_hierarchical_encoder.vhd",                        # Hierarchical encoder
            PROJECT_ROOT / "examples" / "counter" / "vhdl" / "forge_counter_with_encoder.vhd",  # Counter example (monolithic)
        ],
        toplevel="forge_counter_with_encoder",
        test_module="integration.test_platform_oscilloscope_capture",  # Reuse existing test
        category="examples",
    ),

    "example_counter_mcc_split": TestConfig(
        name="example_counter_mcc_split",
        sources=[
            VHDL_PKG / "forge_common_pkg.vhd",                                    # FORGE control scheme
            VHDL_DEBUG / "forge_hierarchical_encoder.vhd",                        # Hierarchical encoder
            PROJECT_ROOT / "examples" / "counter" / "vhdl" / "counter_forge_main.vhd",  # Layer 3: Application logic
            PROJECT_ROOT / "examples" / "counter" / "vhdl" / "counter_forge_shim.vhd",  # Layer 2: Register mapping
            PROJECT_ROOT / "examples" / "counter" / "vhdl" / "CustomWrapper_counter_forge.vhd",  # Layer 1: MCC interface
        ],
