...
--     Layer 1: APP_forge_mcc_top.vhd (uses this package)
...
package APP_forge_common_pkg is
    ...
    --
    -- The forge_bram_loader FSM uses Control02-Control06 to stream data
