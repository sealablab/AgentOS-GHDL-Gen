...
--
-- ⚠️ DEPRECATED (2025-11-11): This component has been superseded by
--    forge_hierarchical_encoder (HVS approach) which provides:
--    - Platform-agnostic digital encoding (no voltage values in VHDL)
--    - Richer encoding (6-bit state + 8-bit status vs 6-bit state only)
--    - Clean separation of concerns (digital domain in VHDL, analog in decoder)
--
-- Migration Path:
--    Replace fsm_observer with forge_hierarchical_encoder:
--    - Located: libs/forge-vhdl/vhdl/debugging/forge_hierarchical_encoder.vhd
--    - Documentation: examples/basic-probe-driver/platform_tests/wrapper/HVS_ENCODER_INTEGRATION.md
--    - Tests: libs/forge-vhdl/tests/forge_hierarchical_encoder_tests/
--
...
-- Status: DEPRECATED (2025-11-11) - Use forge_hierarchical_encoder instead
--------------------------------------------------------------------------------
